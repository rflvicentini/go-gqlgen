...
func (ec *executionContext) field_Mutation_createMeetup_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewMeetup2githubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐNewMeetup(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Meetup_user(ctx context.Context, field graphql.CollectedField, obj *models.Meetup) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNUser2ᚖgithubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_createMeetup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	rctx.Result = res
	ctx = ec.Tracer.StartFieldChildExecution(ctx)
	return ec.marshalNMeetup2ᚖgithubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐMeetup(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMeetup2githubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v models.Meetup) graphql.Marshaler {
	return ec._Meetup(ctx, sel, &v)
}

func (ec *executionContext) marshalNMeetup2ᚕᚖgithubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Meetup) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMeetup2ᚖgithubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐMeetup(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMeetup2ᚖgithubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v *models.Meetup) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) unmarshalNNewMeetup2githubᚗcomᚋrflvicentiniᚋgoᚑgqlgenᚋapiᚋgraphᚋmodelsᚐNewMeetup(ctx context.Context, v interface{}) (models.NewMeetup, error) {
